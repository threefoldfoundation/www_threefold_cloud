  ...
  <section class="py-0 my-10 px-0 shadow-xl bg-white">
    <div class="flex flex-wrap items-center -mx-8">
      <div class="w-1/3 pl-8">
        <g-image class="object-cover" :src="img" :alt="imgAlt" />
      </div>
      <div class="w-2/3 px-20 text-left">
        ...
        <p class="mt-6 mb-8 text-gray-400 leading-relaxed">
          {{ subtitle }} <br />
          can benifit everyone on the planet.
        </p>
        <div
        ...
        >
          <a href="#">
            <svg
              class="fill-current text-green-600 h-11 w-11"
              data-name="Layer 1"
          ...
          ><a
            class="inline-block text-green-600 hover:underline py-2 ml-6 uppercase text-right font-bold"
            href="#"
            >{{ link_text }}</a
          >
        </div>
